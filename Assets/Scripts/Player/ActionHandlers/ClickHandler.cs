...
namespace Player.ActionHandlers
{
    public class ClickHandler : DontDestroyMonoBehaviourSingleton<ClickHandler>
    {
        ...
        public event Action<Vector3> PressedPoint;
        ...
        private void Update()
        {
            ...
            else if (Input.GetMouseButton(0))
            {
                ...
                PressedPoint?.Invoke(pointerUpPosition);
            }
        }
        ...
        public void UnSubscribe(Action<Vector3> dragStartEvent, Action<Vector3> dragEndEvent)
        {
            DragStartEvent -= dragStartEvent;
            DragEndEvent -= dragEndEvent;
        }
